...
import choiraIcon from "../../assets/images/choira-logo-icon.png";
      ...
      <Menu theme="light" mode="inline">
        <Menu.Item key="1">
          <NavLink to="/dashboard">
            ...
            <span className="label">Create Music</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="2">
          <NavLink to="/home">
            ...
            <span className="label">Explore Sample</span>
          </NavLink>
        </Menu.Item>
        {/* <Menu.Item key="2">
          <NavLink to="/tables">
